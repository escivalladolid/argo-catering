with open(r'C:\xampp\htdocs\Capstone-Mobile-Quiz-System\catering-backend\catering-mockup.html', 'r', encoding='utf-8') as f:
    content = f.read()

# Update CSS for brand section
...
with open(r'C:\xampp\htdocs\Capstone-Mobile-Quiz-System\catering-backend\catering-mockup.html', 'w', encoding='utf-8') as f:
    f.write(content)

print('Updated source admin portal')